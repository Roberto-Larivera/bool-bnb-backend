...
<div id="apartments_show">
    ...
    <div class="container-fluid mt-4">
        <div class="row">
            <div class="d-flex flex-column justify-content-lg-between align-items-lg-center">
                    {{-- suddivisione principale in col-11 --}}
                <div class="col-11 main-show">
                    <div class="row">
                        <div class="col">
                            <h2>
                                {{ $apartment->title }}
                ...
                <div class="col-12 col-lg-1 aside-show rounded">
                    <div class="d-flex justify-content-between flex-lg-column align-items-lg-center p-3">
