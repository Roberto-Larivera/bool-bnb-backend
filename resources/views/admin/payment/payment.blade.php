    ...
    <div id="apartments_create" class="container-fluid my-5">
        ...
        <div class="row">
            <div class="col">
                ...
                {{-- Prova stile personalizzato --}}
                <div id="dropin-container">
    

                    <div id="braintree--dropin__dc61964d-ef19-4ec5-9288-cd456bc9315c" data-braintree-id="wrapper" class="braintree-show-card" style="display: none;"><svg data-braintree-id="svgs" style="display: none">
                    <defs>
                    ...
                    <div data-braintree-id="upper-container" class="braintree-upper-container">
                        ...
                        <div data-braintree-id="card" class="braintree-card braintree-form braintree-sheet">
                            ...
                            <div class="braintree-sheet__header-label">
                                ...
                                <div class="braintree-sheet__text">Paga con carta di credito</div>
                            </div>
                    ...
                    <div data-braintree-id="maestro-card-icon" class="braintree-sheet__card-icon">
                        <svg width="40" height="24">
                            ...
                            <div data-braintree-id="number-field-group" class="braintree-form__field-group">
                                <label>
                                <div class="braintree-form__label">Numero carta di credito</div>
                                <div class="braintree-form__field">
                                    <div class="braintree-form-number braintree-form__hosted-field"><iframe src="https://assets.braintreegateway.com/web/3.65.0/html/hosted-fields-frame.min.html#ae0c9531-f1cf-49d3-a5f8-bdf554154803" frameborder="0" allowtransparency="true" scrolling="no" type="number" name="braintree-hosted-field-number" title="Secure Credit Card Frame - Credit Card Number" id="braintree-hosted-field-number" style="border: none; width: 100%; height: 100%; float: left;"></iframe><div style="clear: both;"></div></div>
                            ...
                            <div class="braintree-form__flexible-fields">
                                ...
                                <label>
                                    <div class="braintree-form__label">Data di scadenza
                                    <span class="braintree-form__descriptor">(MM/AA)</span>
                                    </div>
                                    <div class="braintree-form__field">
                                    <div class="braintree-form__hosted-field braintree-form-expiration"><iframe src="https://assets.braintreegateway.com/web/3.65.0/html/hosted-fields-frame.min.html#ae0c9531-f1cf-49d3-a5f8-bdf554154803" frameborder="0" allowtransparency="true" scrolling="no" type="expirationDate" name="braintree-hosted-field-expirationDate" title="Secure Credit Card Frame - Expiration Date" id="braintree-hosted-field-expirationDate" style="border: none; width: 100%; height: 100%; float: left;"></iframe><div style="clear: both;"></div></div>
                                    <div class="braintree-form__icon-container">
                                        <div class="braintree-form__icon braintree-form__field-error-icon">
                                        <svg width="24" height="24">
                                            <use xlink:href="#iconError"></use>
                            ...
                            <div data-braintree-id="save-card-field-group" class="braintree-form__field-group braintree-hidden">
                                ...
                                <div class="braintree-form__label">Salva carta</div>
                                </label>
                            </div>
                            </div>
                        </div>
                    ...
                    <div data-braintree-id="lower-container" class="braintree-test-class braintree-options">
                        <div data-braintree-id="other-ways-to-pay" class="braintree-heading">Altri metodi di pagamento</div>
                    </div>
                    
                    <div data-braintree-id="toggle" class="braintree-large-button braintree-toggle braintree-hidden" tabindex="0">
                        <span>Scegli un altro metodo di pagamento</span>
                    </div>
                    </div>
