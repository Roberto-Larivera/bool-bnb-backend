...
<body>
    <div id="app">
        <header class="navbar aside-navbar sticky-top flex-md-nowrap p-2 shadow">
            <a class="navbar-brand col-md-3 col-lg-2 me-0 px-3 d-flex justify-content-center gap-3 align-items-center"
                href="/">
                <div>
                    Logo
                </div>
            ...
            <div class="d-flex gap-4 align-items-center ms-auto pe-5">
                ...
                <div class="fw-bold fs-5">{{ Auth::user()->name }}
                    <span class="dropdown">
                ...
                <nav id="sidebarMenu" class="col-md-3 col-lg-2 d-md-block aside-navbar sidebar collapse">
                    <div class="position-sticky pt-5">
                        <ul class="nav flex-column px-4 gap-4">
                            <div class="d-flex justify-content-between align-items-center fs-6 text-center mb-5">
                            ...
                            <div class="d-flex flex-column gap-5 aside-item">
                                ...
                                <li class="nav-item">
                                    <a class="p-0 nav-link d-flex justify-content-between align-items-center {{ Route::currentRouteName() == 'admin.test' ? 'active-aside-link' : '' }}"
                                        href="{{ route('admin.dashboard') }}">
