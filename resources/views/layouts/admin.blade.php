...
<body>
    <div id="app">
            ...
            <div class="container-fluid h-100">
                <div class="row h-100">
                    <div class="col d-flex">
                        ...
                        <button class="navbar-toggler burger-menu-admin position-absolute d-md-none collapsed"
                            type="button" data-bs-toggle="collapse" data-bs-target="#sidebarMenu"
                            aria-controls="sidebarMenu" aria-expanded="false" aria-label="Toggle navigation">
                            <span class="navbar-toggler-icon"></span>
                        </button>
                        <div class="d-none d-sm-none d-md-flex align-items-center gap-4  ms-auto me-4">
                            <a href="#nogo" class="text-decoration-none d-flex align-items-center gap-4 h-100">
                        ...
                        document.getElementById('logout-form').submit();">
                                    <i class="fa-solid fa-power-off" data-bs-toggle="tooltip"
        ...
        <div class="container-fluid admin-h">
            <div class="row h-100">
                <nav id="sidebarMenu" class="col-md-4 px-5 col-lg-3 col-xl-2 d-md-block aside-navbar sidebar collapse">
                    ...
                    <ul class="d-flex flex-column justify-content-center h-100 aside-item">
                        ...
                        <li class="nav-item">
                            <a class="nav-link d-flex justify-content-between align-items-center {{ Route::currentRouteName() == 'admin.apartment' ? 'active-aside-link' : '' }}"
                                href="{{ route('admin.apartments.index') }}">
                                <span>Appartamenti</span> <i class="fa-solid fa-building fa-lg fa-fw"></i>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link d-flex justify-content-between align-items-center {{ Route::currentRouteName() == 'admin.prenotazioni' ? 'active-aside-link' : '' }}"
                                href="{{ route('admin.dashboard') }}">
                                <span>Prenotazioni</span> <i class="fa-regular fa-calendar-check fa-lg fa-fw"></i>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link d-flex justify-content-between align-items-center {{ Route::currentRouteName() == 'admin.messaggi' ? 'active-aside-link' : '' }}"
                ...
                <main class="col-12 col-md-8 ms-sm-auto col-lg-9 col-xl-10 px-md-4 main-admin h-100 ">
                    <div>
                        @yield('content')
                    </div>
                </main>
